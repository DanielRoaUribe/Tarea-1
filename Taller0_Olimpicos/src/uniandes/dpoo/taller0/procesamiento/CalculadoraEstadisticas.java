...
public class CalculadoraEstadisticas
{
	...
	{
		Atleta AtletaBus = buscarAtleta(NombreAtleta);
		String Error = "Atleta no encontrado";
		if (!(AtletaBus instanceof Atleta)) {
		   return Error;
		} else 
		{
			String PaisAtleta = AtletaBus.darPais().darNombre();
			return PaisAtleta;
		}
