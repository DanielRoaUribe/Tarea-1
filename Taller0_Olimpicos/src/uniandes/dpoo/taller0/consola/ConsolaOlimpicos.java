...
public class ConsolaOlimpicos
{
	...
	/*Le pide al usuario el nombre de un atleta y luego le muestra el país del atleta
	 * 
	 */
	private void ejecutarPaisAtleta() 
	{
		String ElAtleta = input("Por favor ingrese el nombre de un atleta");
		String PaisAtleta = calculadora.PaisAtleta(ElAtleta);
		if (PaisAtleta == "Atleta no encontrado")
		{
			System.out.println("Error, Atleta no encontrado");
		} else
		{
			System.out.println("El pais de " + ElAtleta + " es: " + PaisAtleta);
		}
	}
